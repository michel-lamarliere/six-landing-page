...
import EmailAddressConfirmation from './after-emails/ChangeEmailAddressConfirmation';
import ChangeForgottenPassword from './after-emails/ChangeForgottenPassword';
...
import ChangeName from './edit-user/pages/ChangeName';
import ChangeEmail from './edit-user/pages/ChangeEmail';
import ChangePassword from './edit-user/pages/ChangePassword';
import ChangeImage from './edit-user/pages/ChangeImage';
...
import DeleteAccount from './edit-user/pages/DeleteAccount';
import DeleteAccountConfirmation from './edit-user/pages/DeleteAccountConfirmation';
import ChangeEmailConfirmation from './edit-user/pages/ChangeEmailConfirmation';
